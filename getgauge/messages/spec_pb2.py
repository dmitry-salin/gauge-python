...
_PROTOSCENARIO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='retriesCount', full_name='gauge.messages.ProtoScenario.retriesCount', index=22,
...
_PROTOCONCEPTRESULT = _descriptor.Descriptor(
  name='ProtoConceptResult',
  full_name='gauge.messages.ProtoConceptResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='protoItem', full_name='gauge.messages.ProtoConceptResult.protoItem', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='executionTime', full_name='gauge.messages.ProtoConceptResult.executionTime', index=1,
      number=2, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='gauge.messages.ProtoConceptResult.timestamp', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PROTOCONCEPTRESULT.fields_by_name['protoItem'].message_type = _PROTOITEM
...
DESCRIPTOR.message_types_by_name['ProtoConceptResult'] = _PROTOCONCEPTRESULT
...
ProtoSpec = _reflection.GeneratedProtocolMessageType('ProtoSpec', (_message.Message,), {
...
ProtoItem = _reflection.GeneratedProtocolMessageType('ProtoItem', (_message.Message,), {
...
ProtoScenario = _reflection.GeneratedProtocolMessageType('ProtoScenario', (_message.Message,), {
...
ProtoTableDrivenScenario = _reflection.GeneratedProtocolMessageType('ProtoTableDrivenScenario', (_message.Message,), {
...
ProtoStep = _reflection.GeneratedProtocolMessageType('ProtoStep', (_message.Message,), {
...
ProtoConcept = _reflection.GeneratedProtocolMessageType('ProtoConcept', (_message.Message,), {
...
ProtoTags = _reflection.GeneratedProtocolMessageType('ProtoTags', (_message.Message,), {
...
ProtoComment = _reflection.GeneratedProtocolMessageType('ProtoComment', (_message.Message,), {
...
ProtoTable = _reflection.GeneratedProtocolMessageType('ProtoTable', (_message.Message,), {
...
ProtoTableRow = _reflection.GeneratedProtocolMessageType('ProtoTableRow', (_message.Message,), {
...
ProtoStepExecutionResult = _reflection.GeneratedProtocolMessageType('ProtoStepExecutionResult', (_message.Message,), {
...
ProtoExecutionResult = _reflection.GeneratedProtocolMessageType('ProtoExecutionResult', (_message.Message,), {
...
ProtoHookFailure = _reflection.GeneratedProtocolMessageType('ProtoHookFailure', (_message.Message,), {
...
ProtoSuiteResult = _reflection.GeneratedProtocolMessageType('ProtoSuiteResult', (_message.Message,), {
...
ProtoSpecResult = _reflection.GeneratedProtocolMessageType('ProtoSpecResult', (_message.Message,), {
...
ProtoScenarioResult = _reflection.GeneratedProtocolMessageType('ProtoScenarioResult', (_message.Message,), {
...
ProtoConceptResult = _reflection.GeneratedProtocolMessageType('ProtoConceptResult', (_message.Message,), {
  'DESCRIPTOR' : _PROTOCONCEPTRESULT,
  '__module__' : 'spec_pb2'
  # @@protoc_insertion_point(class_scope:gauge.messages.ProtoConceptResult)
  })
_sym_db.RegisterMessage(ProtoConceptResult)

ProtoStepResult = _reflection.GeneratedProtocolMessageType('ProtoStepResult', (_message.Message,), {
...
ProtoStepValue = _reflection.GeneratedProtocolMessageType('ProtoStepValue', (_message.Message,), {
