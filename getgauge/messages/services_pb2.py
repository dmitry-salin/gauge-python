...
_RUNNER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    index=1,
    containing_service=None,
    input_type=messages__pb2._SUITEDATASTOREINITREQUEST,
  ...
  _descriptor.MethodDescriptor(
    ...
    index=3,
    containing_service=None,
    input_type=messages__pb2._SPECDATASTOREINITREQUEST,
    output_type=messages__pb2._EXECUTIONSTATUSRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  ...
  _descriptor.MethodDescriptor(
    ...
    index=5,
    containing_service=None,
    input_type=messages__pb2._SCENARIODATASTOREINITREQUEST,
    output_type=messages__pb2._EXECUTIONSTATUSRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
...
_REPORTER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='NotifyConceptExecutionStarting',
    full_name='gauge.messages.Reporter.NotifyConceptExecutionStarting',
    index=3,
    containing_service=None,
    input_type=messages__pb2._CONCEPTEXECUTIONSTARTINGREQUEST,
    output_type=messages__pb2._EMPTY,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='NotifyConceptExecutionEnding',
    full_name='gauge.messages.Reporter.NotifyConceptExecutionEnding',
    index=4,
    containing_service=None,
    input_type=messages__pb2._CONCEPTEXECUTIONENDINGREQUEST,
    output_type=messages__pb2._EMPTY,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
...
_DOCUMENTER = _descriptor.ServiceDescriptor(
  name='Documenter',
  full_name='gauge.messages.Documenter',
  file=DESCRIPTOR,
  index=2,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='GenerateDocs',
    full_name='gauge.messages.Documenter.GenerateDocs',
    index=0,
    containing_service=None,
    input_type=messages__pb2._SPECDETAILS,
    output_type=messages__pb2._EMPTY,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='Kill',
    full_name='gauge.messages.Documenter.Kill',
    index=1,
    containing_service=None,
    input_type=messages__pb2._KILLPROCESSREQUEST,
    output_type=messages__pb2._EMPTY,
...
_sym_db.RegisterServiceDescriptor(_DOCUMENTER)

DESCRIPTOR.services_by_name['Documenter'] = _DOCUMENTER
